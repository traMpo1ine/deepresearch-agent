...
GENERATED_REQUIREMENTS = {
    ...
    "deepseek writer golden demo": [
        ...
        "reports/golden_demo/deepseek_v3/plan.md",
        "reports/golden_demo/deepseek_v3/memory_trace.md",
        "reports/golden_demo/deepseek_v3/compression_trace.md",
        "reports/golden_demo/deepseek_v3/eval_summary.md",
