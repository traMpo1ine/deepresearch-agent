...
EXPECTED_TEXT = {
    "README.md": [
        ...
        "run_demo_server.py",
        "run_llm_verifier_smoke.py",
        "researchbench_extended.jsonl",
        "pre_resume_evidence_pack",
        "formal verifier benchmark",
        "GitHub 作品集配置清单",
        "简历第二项目最终版",
        ...
        "page-aware",
        "corpus profile",
        "真实 LLM 输出不能和 offline/mock benchmark 指标混写",
        "inspect_orchestration_failure.py",
        "inspect_redblue_convergence.py",
        "run_live_source_eval.py",
        "SQLite/Redis TTL cache",
        "arXiv",
        "X-Request-ID",
