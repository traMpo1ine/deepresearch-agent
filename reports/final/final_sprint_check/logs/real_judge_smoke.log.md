$ D:\学习deepsearch\.venv\Scripts\python.exe scripts/run_real_judge_smoke.py --backend mock --limit 5 --output reports\final\final_sprint_check\real_judge_smoke.md
