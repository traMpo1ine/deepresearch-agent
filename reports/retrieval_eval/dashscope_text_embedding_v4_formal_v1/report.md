...
- Generated (UTC): `2026-07-17T08:06:29.273713+00:00`
...
| vector | 0.690 | 0.886 | 0.943 | 1.000 | 0.886 | 0.910 | 0.890 | 4 |
| hybrid | 0.662 | 0.810 | 0.867 | 0.943 | 0.771 | 0.852 | 0.822 | 8 |
...
| hard | 5 | 0.867 | 0.600 | 0.767 |
| medium | 19 | 0.868 | 0.789 | 0.882 |

### By domain

| Group | Cases | Recall@5 | All relevant@5 | MRR@5 |
|---|---:|---:|---:|---:|
| agent_orchestration | 5 | 1.000 | 1.000 | 0.850 |
| citation_verification | 3 | 0.500 | 0.333 | 0.500 |
| context_compression | 2 | 0.750 | 0.500 | 1.000 |
| engineering_tradeoff | 5 | 0.800 | 0.800 | 0.800 |
| evaluation | 5 | 0.933 | 0.800 | 1.000 |
...
| rb_025 | textrank_context | failure_modes, vector_database_limits, llm_judge, hotpotqa_multihop, dag_orchestration | Why can over-compression hurt research quality? |
| rb_027 | bootstrap_ci | cohens_d, hybrid_memory_design, llm_judge, offline_first, dag_orchestration | How would you evaluate baseline versus full pipeline? |
...
| rb_035 | technical_blog | resume_alignment, agent_planning, textrank_context, red_blue_repair, hybrid_memory_design | What project artifacts should exist by the end? |
